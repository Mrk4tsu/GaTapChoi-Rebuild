...
namespace GaVL.Data.Migrations
{
    ...
    [Migration("20260318092610_UpdateOrderTable1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GaVL.Data.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 18, 9, 26, 9, 887, DateTimeKind.Utc).AddTicks(4847))
            ...
            modelBuilder.Entity("GaVL.Data.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 18, 9, 26, 9, 888, DateTimeKind.Utc).AddTicks(1405))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 18, 9, 26, 9, 888, DateTimeKind.Utc).AddTicks(1556))
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Sumary"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Sumary"), new[] { "gin_trgm_ops" });
            ...
            modelBuilder.Entity("GaVL.Data.Entities.UserContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 18, 9, 26, 9, 890, DateTimeKind.Utc).AddTicks(5555))
                        .HasColumnName("created_at");
