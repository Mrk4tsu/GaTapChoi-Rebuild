...
namespace GaVL.Data.Migrations
{
    ...
    [Migration("20260318092202_UpdateOrderTable")]
            ...
            modelBuilder.Entity("GaVL.Data.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 18, 9, 22, 2, 215, DateTimeKind.Utc).AddTicks(1316))
            ...
            modelBuilder.Entity("GaVL.Data.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 18, 9, 22, 2, 215, DateTimeKind.Utc).AddTicks(7900))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 18, 9, 22, 2, 215, DateTimeKind.Utc).AddTicks(8043))
            ...
            modelBuilder.Entity("GaVL.Data.Entities.UserContact", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 18, 9, 22, 2, 218, DateTimeKind.Utc).AddTicks(2399))
                        .HasColumnName("created_at");
