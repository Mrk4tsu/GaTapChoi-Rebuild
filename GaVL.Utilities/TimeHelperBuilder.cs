...
{
    public class TimeHelperBuilder
    {
        public DateTime Timestamp { get; }
        public string TimeZone { get; }
        public bool RemoveTick { get; }

        private TimeHelperBuilder(Builder builder)
        {
        ...
        public static implicit operator DateTime(TimeHelperBuilder timeProcessor)
        {
        ...
        public class Builder
        {
            ...
            public TimeHelperBuilder Build()
            {
                return new TimeHelperBuilder(this);
            }
        }
    }
}
